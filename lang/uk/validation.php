...
return [
    ...
    */
    ...
    "ulid" => "Поле :attribute має бути коректним ULID ідентифікатором.",
    "uuid" => "Поле :attribute має бути коректним UUID ідентифікатором.",

    /*
    |--------------------------------------------------------------------------
    | Мовні рядки для власних перевірок на коректність даних.
    |--------------------------------------------------------------------------
    |
    | Тут ви можете вказати власні повідомлення для перевірки атрибутів, 
    | використовуючи конвенцію "атрибут.rule" для назви рядків. 
    | Це дозволяє швидко вказати конкретний мовний рядок для заданого 
    | правила атрибута.
    |
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Атрибути для власних перевірок на коректність даних.
    |--------------------------------------------------------------------------
    |
    | Наступні мовні рядки використовуються для заміни місця заповнювача 
    | атрибутів на щось більш зрозуміле читачам, наприклад, "E-Mail Address" 
    | замість "email". Це просто допомагає надати нашим повідомленням 
    | більш виразний вигляд.
    |
    */
