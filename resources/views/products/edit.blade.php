...
<form method="POST" action="{{ route('products.update', $product->id) }}">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="text" name="code" class="form-control" id="inputCode" placeholder="Code" value="{{ $product->code }}">
        </div>
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10 input-group">
            <input type="text" name="d_begin" class="form-control input-date" id="input_d_begin" placeholder="Date begin" value="{{ $product->d_begin }}" autocomplete="off">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10 input-group">
            <input type="text" name="d_end" class="form-control input-date" id="input_d_end" placeholder="Date end" value="{{ $product->d_end }}" autocomplete="off">
            <div class="input-group-append">
                <span class="input-group-text"><i class="far fa-calendar-alt"></i></span>
            </div>
        </div>
